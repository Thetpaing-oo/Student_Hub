                ...
                <div class="section__content section__content--p30">
                    <div class="container-fluid">
                        <div class="row m-t-25">
                            <div class="row">
                                <div class="col">
                                    <div class="row w-100"><div class="col" style="float:left;"><h2 class="title-1 m-b-25">Managing Classes</h2></div><div class="col" style="position:absolute;left:100%;"><Button class="btn btn-primary btn-sm"><i class="fa fa-plus" style="color:white;"></i>&nbsp;ADD</Button></div></div>
                                    <div class="table-responsive table--no-card table-wrapper-scroll-y my-custom-scrollbar m-b-20 w-auto"  style="margin-left:300px;">
                                        <table class="table table-borderless table-hover">
                                            <thead style="background-color: deepskyblue;color:aliceblue;">
                                                <tr>
                                                  
                                                    <th class="text-right">Class No</th>
                                            ...
                                            ResultSet rs=obj.getClassmangenent();
                                            while(rs.next()){%>
                                            	 <tr>
                                                   
                                                    <td ><%= rs.getString("class_no") %></td>
                                                    <td ><%= rs.getString("class_name") %></td>
                                                    <td ><a href="#" class="btn btn-outline-primary btn-sm">Edit</a>&nbsp;<a href="#" class="btn btn-outline-primary btn-sm">Cancel</a></td>
                                                </tr>
                                           <%  }
                                            %>
