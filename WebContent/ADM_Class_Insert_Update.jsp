...
window.onclick = function(event) {
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="overview-wrap">
                                    <h2 class="title-1">Class Managing</h2>
                                </div>
                            </div>
                        </div>
            ...
            <section class="statistic">
                <div class="section__content section__content--p30">
                    <div class="container-fluid">
                        ...
                        if(classId==null){
                        %>
                        <label>Class Insertion</label>
                        <%
                        }else{
                        %>
                        <label>Class Updatation</label>
                        <%
                        }
                        %>
                        </h2></center>
  ...
  <div class="form-outline mb-4">
    <input type="text" id="form1Example2" class="form-control" placeholder="Enter Class Name" name="className" required/>
  </div>
