                                ...
                                <div class="col">
                                    ...
                                    <div class="table-wrapper-scroll-x table-wrapper-scroll-y my-custom-scrollbar">
                                        <table class="table table-borderless table-hover" width="100%" height="100%">
                                            ...
                                            ResultSet rs=obj.getTimetable();
                                            while(rs.next()){%>
                                            	<tr>
                                                    <td><%= rs.getString("id") %></td>
                                                    <td><%= rs.getString("class_no") %></td>
                                                    <td><%=rs.getString("subj_code1") %></td>
                                                    <td><%=rs.getString("subj_code2") %></td>
                                                    <td><%=rs.getString("subj_code3") %></td>
                                                    <td><%=rs.getString("subj_code4") %></td>
                                                    <td><%=rs.getString("subj_code5") %></td>
                                                    <td><%=rs.getString("subj_code6") %></td>
                                                    <td><a href="#" class="btn btn-outline-primary btn-sm"><i class="fa fa-edit"></i></a><a href="#" class="btn btn-outline-danger btn-sm"><i class="fa fa-trash"></i></a></td>
                                                </tr>
                                           <% }
                                            %>
