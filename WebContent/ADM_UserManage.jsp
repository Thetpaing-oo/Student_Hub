                                ...
                                <div class="col">
                                    ...
                                    <div class="table-responsive table--no-card table-wrapper-scroll-x table-wrapper-scroll-y my-custom-scrollbar m-b-20 w-auto">
                                        <table class="table table-borderless table-hover">
                                            ...
                                            ArrayList<User> user=(ArrayList<User>)obj.getAllUser();
                            				for(User u:user){%>
                            					                                                <tr>
                                                    <td><%=u.getId() %></td>
                                                    <td><%=u.getUsername() %></td>
                                                    <td><%=u.getEmail() %></td>
                                                    <td class="text-right"><%=u.getPhone() %></td>
                                                    <td class="text-right"><%= u.getAddress()%></td>
                                                    <td class="text-right"><%=u.getGender() %></td>
                                                    <td class="text-right"><%=u.getRole()%></td>
